...
from opticalflow import flow2colorimage
...
def main():
    ...
    sVideoPath = "data-set/04-chalearn/train/c049/M_00831.avi"
    sFlowDir = "data-temp/test"
    ...
    while(1):
        ...
        #_, bgrFarnback = flowsToColor(flowFarnback, hsv)
        bgrFarnback = flow2colorimage(flowFarnback)

        flowTVL1 = compute_TVL1(prvs, next)
        _, bgrTVL1 = flowsToColor(flowTVL1, hsv)
