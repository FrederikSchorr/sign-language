...
def train_I3D_top(diVideoSet, bImage = True, bOflow = True):
    ...
    if bImage:
        ...
        train_feature_generator(sImageFeatureDir, sModelDir, sLogPath, keI3DtopImage, oClasses,
    ...
    if bOflow:
        ...
        train_feature_generator(sOflowFeatureDir, sModelDir, sLogPath, keI3DtopOflow, oClasses,
            nBatchSize, nEpochs, fLearn)
...
if __name__ == '__main__':
    ...
    train_I3D_top(diVideoSet, bImage = True, bOflow = True)